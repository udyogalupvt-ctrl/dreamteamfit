...
function Page(){
 ...
 return <div className="space-y-6"><PageHeader title="Workout Plans" description="Reusable workout plans your staff can assign to clients." breadcrumbs={[{label:"Home",to:"/dashboard"},{label:"Workout Plans"}]} actions={<Button onClick={()=>{setEditing(null);setOpen(true)}}><Plus/> New plan</Button>}/>
