...
function Page(){
 ...
 return <div className="space-y-6"><PageHeader title="Diet Plans" description="Reusable diet plans your staff can assign to members." breadcrumbs={[{label:"Home",to:"/dashboard"},{label:"Diet Plans"}]} actions={<Button onClick={()=>{setEditing(null);setOpen(true)}}><Plus/> New plan</Button>}/>
