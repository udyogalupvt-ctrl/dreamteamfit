import { doc,onSnapshot,serverTimestamp,setDoc } from "@/lib/firestore";import { db } from "@/lib/firebase";import { DEFAULT_AUTOMATION_SETTINGS } from "@/lib/automation-templates";import { COLLECTIONS } from "./firestore.service";import type { AutomationSettings } from "@/types/models";
